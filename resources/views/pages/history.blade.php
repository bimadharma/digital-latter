        ...
        <table id="riwayatTable" class="table table-bordered table-striped">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="{{ route('surat.edit', $history->surat->id) }}" class="btn btn-warning btn-sm">Edit</a>
                        <a href="{{ route('surat.print', ['id' => $history->surat->id, 'format' => 'pdf']) }}" class="btn btn-danger btn-sm">PDF</a>
                        <a href="{{ route('surat.print', ['id' => $history->surat->id, 'format' => 'docx']) }}" class="btn btn-primary btn-sm">Word</a>
                    </td>
                </tr>
                @empty
                <tr>
